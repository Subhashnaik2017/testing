 <div id="page-title">
          <h1 class="page-header text-overflow">Institute</h1>
          <!--Searchbox-->
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="#" class="btn-link">Intitute_name</a></td>
                          <td>email_address@gmail.com</td>
                          <td>Location</td>
                          </td>
                          <td class="text-right">
                            <a href="" class="btn btn-danger btn-sm">Remove</a>
                            <a href="" class="btn btn-info btn-sm" data-target="#edit-institute-modal" data-toggle="modal">Edit</a>
                          </td>
                        </tr>
                        <tr>
                          <td><img src="img/profile-photos/1.png" alt="" height="50"></td>
